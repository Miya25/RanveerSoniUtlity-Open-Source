require("http").createServer((req, res) => res.end("RanveerSoniUtlity By Ranveer")).listen(process.env.PORT || 8080)
...
setInterval(async () => {
  UrlsConfig.countDocuments({}, (err, total) => {
    client.projectsSize = total;
    client.user.setActivity(`rsu!help`, {
      type: "STREAMING",
    });
  });
...
client.on('guildCreate', guild => {
 ...
 .setURL('')
 .setDescription(' <a:loading:881979583577092197> Thank You For Inviting Me. My prefix is `rsu!`. Run rsu!help for more info about me!')
